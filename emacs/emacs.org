...
Mostly followed this setup from [[https://systemcrafters.net/build-a-second-brain-in-emacs/5-org-roam-hacks/][Systemcrafter]].
#+begin_src emacs-lisp
...
** Agenda
Show all tasks from project files - that is, files tagged as project.
...
*** Capturing into the inbox for later processing
#+begin_src emacs-lisp
