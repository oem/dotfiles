...
* Edit
** code
In general I would require diagnostics (errors, warnings and other insights) and autofixing for programming. If at all possible the diagnostics should be provided by a language server to get the most information.
*** show line numbers
