...
export FZF_DEFAULT_OPTS=$FZF_DEFAULT_OPTS' --color=fg:#d0d0d0,bg:#000000,hl:#0080ff --color=fg+:#000000,bg+:#ffffff,hl+:#5fd7ff --color=info:#81fa00,prompt:#000000,pointer:#0080ff --color=marker:#81fa00,spinner:#ffffff,header:#ffffff'
# }}}
